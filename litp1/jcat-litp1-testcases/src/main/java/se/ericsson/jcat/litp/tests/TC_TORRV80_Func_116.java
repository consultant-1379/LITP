...
public class TC_TORRV80_Func_116 extends LitpJcatNgTestCase {
	
	private SSHConnect connect = null;
	private static String name = null;
//	private static int no_vm = 5;
	/**
	 * @param name
	 */
	public TC_TORRV80_Func_116(String name) {
		super(name);
		this.name = name;
		// TODO Auto-generated constructor stub
	}
	public TC_TORRV80_Func_116(SSHConnect connect)
	{
		super(name);
...
//		}
	...
	public synchronized void isSingleNode() {
	...
	public synchronized void isMultiNode() {
	...
	public synchronized void virshList() {
